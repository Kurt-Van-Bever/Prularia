...
public partial class PrulariaContext : DbContext
{
    ...
    public virtual DbSet<Veelgesteldevraagartikel> Veelgesteldevragenartikel { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Bestelling>(entity =>
        {
            ...
            entity.HasOne(d => d.FacturatieAdres).WithMany(p => p.BestellingenFacturatieAdressen)
            ...
            entity.HasOne(d => d.LeveringsAdres).WithMany(p => p.BestellingenLeveringsAdressen)
        ...
        modelBuilder.Entity<Klant>(entity =>
        {
            ...
            entity.HasOne(d => d.FacturatieAdres).WithMany(p => p.KlantenFacturatieAdressen)
                .HasForeignKey(d => d.FacturatieAdresId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_Klanten_Adressen1");

            entity.HasOne(d => d.LeveringsAdres).WithMany(p => p.KlantenLeveringsAdressen)
                .HasForeignKey(d => d.LeveringsAdresId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Veelgesteldevraagartikel>(entity =>
        {
            entity.HasKey(e => e.VeelgesteldeVraagArtikelId).HasName("PRIMARY");

            entity.ToTable("veelgesteldevragenartikels");

            entity.HasIndex(e => e.ArtikelId, "fk_VeelgesteldeVragenArtikels_Artikelen1_idx");

            entity.Property(e => e.VeelgesteldeVraagArtikelId).HasColumnName("veelgesteldeVragenArtikelId");
            entity.Property(e => e.Antwoord)
                .HasMaxLength(255)
                .HasColumnName("antwoord");
            entity.Property(e => e.ArtikelId).HasColumnName("artikelId");
