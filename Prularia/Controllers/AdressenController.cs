...
namespace Prularia.Controllers
{
    public class AdressenController : Controller
    {
        ...
        public AdressenController(PrulariaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AdresId,Straat,HuisNummer,Bus,PlaatsId,Actief")] Adres adressen)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AdresId,Straat,HuisNummer,Bus,PlaatsId,Actief")] Adres adressen)
        {
